...
public class VideoQuiz extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "VideoQuizModel", version = "1.0",
          description = "A las2peer microservice generated by the CAE.",
          termsOfService = "none",
          contact = @Contact(name = "Mario", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/CAE-Mario/microservice-VideoQuizModel/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  @ApiResponses(value = {
       @ApiResponse(code = HttpURLConnection.HTTP_OK, message = "questionasJSONObject")
  })
  @ApiOperation(value = "GetQuiz", notes = " ")
  public Response GetQuiz(@PathParam("id") String id) {
try{ 
         Connection conn = service.dbm.getConnection();  
        PreparedStatement stmnt = conn.prepareStatement("SELECT question, videolink, answerA, answerB, answerC, answerD from videoquiz.Quiz where Quiz.id = " + id); 
